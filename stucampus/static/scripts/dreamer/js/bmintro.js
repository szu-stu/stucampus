function introduce(bm){
	...
	if(bm==1){
		...
		$(e).addClass("act");
		$(f).removeClass("act");
		intro.innerHTML = "<h3>学子头条君</h3><h1>学子头条君是学子天地的一个新兴项目，系深大第一家校园热点新闻路访类视频节目，由主编领导，旗下包括素材组、拍摄组与后期组三个小组，节目的内容形式为周更，主要是以与深大学子们息息相关的校园热点话题和新闻为内容进行路访或专访力求让更多人了解深大学生的生活以及想法。</h1>";
	}
}